...
// /**
//  * @brief
//  *  setw 设置流中下一个输出项的宽度，默认右对齐
//  * @param request
//  * @param response
//  * @param session
//  * @return int32_t
//  */
// int32_t StatusServlet::handle(webs::http::HttpRequest::ptr request, webs::http::HttpResponse::ptr response, webs::http::HttpSession::ptr session) {
//     response->setHeader("Content-Type", "text/text; charset=utf-8");
/* #define XX(key) \ */
//     ss << std::setw(30) << std::right << key ": "
//     std::stringstream ss;
//     ss << "===================================================" << std::endl;
//     XX("server_version") << "webs/1.0.0" << std::endl;
...
//     ss << "===================================================" << std::endl;
//     XX("fibers") << webs::Fiber::TotalFibers() << std::endl;
//     ss << "===================================================" << std::endl;
//     ss << "<Logger>" << std::endl;
//     ss << webs::LoggerMgr::GetInstance()->toYamlString() << std::endl;
//     ss << "===================================================" << std::endl;
//     ss << "<Woker>" << std::endl;
//     webs::WorkerMgr::GetInstance()->dump(ss) << std::endl;

//     std::map<std::string, std::vector<TcpServer::ptr>> servers;
//     webs::Application::GetInstance()->listAllServer(servers);
//     ss << "===================================================" << std::endl;
...
//             }
//             if (!hs) {
//                 hs = std::dynamic_pointer_cast<webs::http::HttpServer>(*iit);
//             }
